...
<%
    ...
    String searchProblem = "SELECT bio.`PATIENT_NAME`, app.appointment_date , app.userid, app.start_time, app.end_time FROM pms_appointment app INNER JOIN pms_patient_biodata bio ON app.pmi_no = bio.`PMI_NO`  WHERE app.hfc_cd = '"+hfc_cd+"' AND app.discipline = '"+discipline_cd+"' AND app.subdiscipline = '"+subdiscipline_cd+"';";
